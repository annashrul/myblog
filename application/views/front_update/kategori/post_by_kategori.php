        ...
        <div class="row">
          <div class="col-md-12">        
            <ol class="breadcrumb">
              ...
              <li class="active"><?=$postByKategori[0]->nama_kategori?></li>
            </ol>
            <!-- <h1 class="page-title"><?=$postByKategori[0]->nama_kategori?></h1> -->
          </div>
        </div>
        <div class="line"></div>
        <div class="row">
          <?php foreach($postByKategori as $pk):?>
            ...
            <div class="inner">
              ...
              <div class="details">
                ...
                <div class="col-md-12" style="height:130px;padding:0px 0px 0px 0px;">
                  <h1><a href="<?=base_url($pk->slug_artikel_post)?>"><?=htmlspecialchars(strip_tags($pk->judul_post))?></a></h1>
                  <p class="text-left"><?=htmlspecialchars(strip_tags(substr($pk->artikel_post,0,170)))?></p>
                </div>
                <footer>
        ...
        <aside>
          ...
          <div class="aside-body">
            ...
            <article class="article-mini">
              ...
              <div class="padding">
                <h1><a href="<?=base_url($atbk->slug_artikel_post)?>"><?=htmlspecialchars(strip_tags(substr($atbk->judul_post,0,50)))?></a></h1>
                <div class="detail">
